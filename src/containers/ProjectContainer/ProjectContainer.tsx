  ...
  return isSelected ? (
    <div className={styles.ProjectContainer__background}>
      <article className={styles.ProjectContainer} ref={projectSelectorRef}>
        {project !== null && (
          <>
            <div className={styles.ProjectContainer__ExitBtn} onClick={() => closeProject()}>
              &#10006;
            </div>
            <div className={styles.ProjectContainer__Content}>
              ...
              <div className={styles.ProjectContainer__Techs}>
                <h3>
                  <FormattedMessage id="project.technologies" defaultMessage="Technologies" />
                </h3>
            ...
            <div className={styles.ProjectContainer__Slides}>
              ...
              <div className={styles.ProjectContainer__LinkButtons}>
                <a href={project.deployLink} target="_blank" rel="noreferrer">
                  <Button textId="project.deployBtnLink" defaultText="Go to site" />
                </a>
                <a href={project.repositoryLink} target="_blank" rel="noreferrer">
                  <Button
                    textId="project.repositoryBtnLink"
                    defaultText="See source code"
                    topColor="#008AB0"
                    bottomColor="#00B2DF"
                  />
                </a>
            ...
            <div
              className={styles.ProjectContainer__PrevSlide}
              onClick={() => prevProject(project.id)}>
              {"<"}
            </div>
            <div
              className={styles.ProjectContainer__NextSlide}
